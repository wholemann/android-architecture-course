...
public class QuestionListController implements
    ...
    public QuestionListController(FetchLastActiveQuestionsUseCase fetchLastActiveQuestionsUseCase, ScreensNavigator screensNavigator, ToastsHelper toastsHelper) {
